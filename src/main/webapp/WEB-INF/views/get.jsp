...
<link rel="stylesheet" href="https://cdnjs.cl oudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
</head>
<body>
	<my:navBar />
	<my:alert></my:alert>
	<div class="container-lg">
		...
		<div class="row justify-content-center">
			<div class="col-12 col-md-8 col-lg-6">
				<h1>
					<i class="fa-solid fa-quote-left" style="color: #657be6;"></i>
					${board.id }번 게시물
					<i class="fa-solid fa-quote-right" style="color: #657be6;"></i>
				</h1>
				<div>
					<div class="mb-3">
